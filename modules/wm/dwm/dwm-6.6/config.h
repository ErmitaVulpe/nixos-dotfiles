...
static const char col_purpl[]        = "#B200FF";
...
static const Rule rules[] = {
    ...
    { "app-launcher", NULL,   NULL,       0,            1,           1,           -1 },
};
...
// static const char *applaunchercmd[] = { "wezterm", "start", "--class", "app-launcher", "-e", "otter-launcher" };
static const char *termcmd[]  = { "wezterm", NULL };
static const char *lockscreencmd[]  = { "loginctl", "lock-session", NULL };
